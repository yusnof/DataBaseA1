...
--Creates a view that shows the finished courses of the students
--The view is created by joining the Taken table with the Courses table
...
--Creates a view that shows the passed courses of the students
